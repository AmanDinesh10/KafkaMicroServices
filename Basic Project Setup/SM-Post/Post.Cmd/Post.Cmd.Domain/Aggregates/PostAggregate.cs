...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        public void EditMessage(string message)
        {
            ...
            {
                throw new InvalidOperationException($"This value of {nameof(message)} cannot be null or empty. Please provide a valid {nameof(message)}!");
            }
        ...
        public void AddComment(string comment, string username)
        {
            ...
            {
                throw new InvalidOperationException($"This value of {nameof(comment)} cannot be null or empty. Please provide a valid {nameof(comment)}!");
            }
